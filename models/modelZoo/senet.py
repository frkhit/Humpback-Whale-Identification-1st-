...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
                 ...
                 downsample_padding=1, num_classes=1000, inchannels=4):
        """
        Parameters
        ----------
...
def senet154(num_classes=1000, pretrained='imagenet', inchannels=3):
    model = SENet(SEBottleneck, [3, 8, 36, 3], groups=64, reduction=16,
                  dropout_p=0.2, num_classes=num_classes, inchannels=inchannels)
...
def se_resnet101(num_classes=1000, pretrained='imagenet', inchannels=3):
